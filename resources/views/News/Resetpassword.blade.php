...
<form action="{{url('resetvalue')}}" method="post">
	   {{csrf_field()}}
<table>
<tr><td><input type="hidden" name="rpToken"  value={{Session::get('rpToken')}}></td></tr>	
<tr><td>Current Password:</td><td><input type="password" name="password" value={{Session::get('password')}}></td></tr>
<tr><td>New Password:</td><td><input type="password" name="newpassword"></td></tr> 
<tr><td>Conform password:</td><td><input type="password" name="conformpassword"></td></tr>
